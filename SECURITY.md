...
Only the current `master` branch is maintained. There are no versioned releases.
...
This is a small internal service. Fixes are made on a best-effort basis and
